...
/* -------------------------------------------------------------------------
  ...
  private final JTextArea storyJTextArea = new JTextArea(32, 60);
  ...
  private final JButton choice1JButton = new JButton("1");
  private final JButton choice2JButton = new JButton("2");
  private final JButton choice3JButton = new JButton("3");
  private final JButton choice4JButton = new JButton("4");
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    ...
    // A JPanel for the middle center part of the main grid with a FlowLayout.
    // This is for the story page.
    JPanel middlePartJPanel = new JPanel();
    contents.add(middlePartJPanel, BorderLayout.CENTER);
    middlePartJPanel.setLayout(new FlowLayout());
...
/* -------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    ...
    // One text area for the middle JPanel.
    // This is for the story.
    middlePartJPanel.add(new JScrollPane(storyJTextArea));
...
/* -------------------------------------------------------------------------
  ...
  public void choiceSelect(int choiceSelected)
  {
    ...
    storyJTextArea.append("\n" + theGame.getStory().getChoice(choiceSelected).getChoiceStory());  
    theGame.nextStage(choiceSelected);

    // Set the story and choices.
    storyJTextArea.append("\n" + theGame.getStory().getStory());
